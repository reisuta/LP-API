...
('お酒を飲む頻度とそのスタイルを教えてください', 1, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_1);
...
('毎日飲まなきゃやってらんない。たいてい一人で飲む。そして本当は酒はあまり好きじゃない', 10, true, @diagnosis_question_id_1);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('みな機会において平等であるべきだ。そして、実力があるものこそ上に立つべきだ。', -2, true, @diagnosis_question_id_2),
('明るく社交的な人物は優秀であり、暗く内向的な人物は劣等である。', -5, true, @diagnosis_question_id_2),
('とにかく分かりやすく役に立ちそうなものを使えばいい。細かいことは考える必要はない。', -10, true, @diagnosis_question_id_2),
('何が正しいかなんてわからない。そのため何事も研究が欠かせない。', 1, true, @diagnosis_question_id_2),
('思想はある種の趣味で、固有のものだから、共感できる思想はない。', 3, true, @diagnosis_question_id_2);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('世間で言われるところの「常識」についてどう思いますか？', 20, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_1);
SET @diagnosis_question_id_3 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('非常識にならないためにも、遵守すべき規範であり、絶対に守らなければならないと思う。', -5, true, @diagnosis_question_id_3),
('常識がないやつは、変なやつだと思うので、私は嫌いだ。なお私は常識人です。', -5, true, @diagnosis_question_id_3),
('常識の定義がいまいちわからないので、答えかねます。', 1, true, @diagnosis_question_id_3),
('「世間の常識では」と説教する人が言う、「常識」は、その人の主観でしかないと思う。', 2, true, @diagnosis_question_id_3),
('常識が正しいと信じ込むのは、思考停止だと思う。', 1, true, @diagnosis_question_id_3);
...
INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('今まで「「私」とは何か？」と、自問したことはどれぐらいありましたか？', 20, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_2);
SET @diagnosis_question_id_4 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('一度もない', -5, true, @diagnosis_question_id_4),
('幼少期に一度あったかもしれない。', 0, true, @diagnosis_question_id_4),
('私自身は一度もないが、その問いに悩む人の気持ちはわからなくもない', 0, true, @diagnosis_question_id_4),
('青年時代、この問いについて真剣に考えたことがある。', 2, true, @diagnosis_question_id_4),
('生まれてこのかた、この問いから目を反らすことができないでいる。', 4, true, @diagnosis_question_id_4);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('好きな本のタイプを教えてください。', 5, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_2);
SET @diagnosis_question_id_5 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('自己啓発、ビジネス書などの、ノウハウが書かれており、すぐに役立ちそうなもの', -10, true, @diagnosis_question_id_5),
('大衆小説や、漫画など、娯楽や暇つぶしに適している本', 0, true, @diagnosis_question_id_5),
('純文学や哲学書、専門書、学術書といった、自分なりに噛み砕いて考える必要がある本。', 1, true, @diagnosis_question_id_5);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('どのようにして仕事を進めることが多いですか？', 2, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_2);
SET @diagnosis_question_id_6 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('チームで役割分担をし、自ら先頭に立って、みなに指示を出して仕事を進めていく。', -5, true, @diagnosis_question_id_6),
...
INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('理想的な仕事のペースはどの程度ですか？', 2, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_3);
...
INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('どのように話すことが多いですか？', 4, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_3);
...
('ジェスチャーを織り交ぜて、相手が理解しやすいよう工夫する。', -2, true, @diagnosis_question_id_8),
('世間話が多く、とりとめのない話し方をすることが多い。', 0, true, @diagnosis_question_id_8),
('人間嫌いなので、あんまり人と話さない。', 1, true, @diagnosis_question_id_8);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('あなたは一億円を手に入れました。何に使いますか？', 1, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_3);
...
('放蕩', 1, true, @diagnosis_question_id_9),
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('非常識な言動が目立つ人', -5, true, @diagnosis_question_id_10),
('多くの人が持ちえない、独特の嗜好や考え方をする人', 0, true, @diagnosis_question_id_10),
('月並みでない、何らかの点で優秀な人', 1, true, @diagnosis_question_id_10),
('考えるも何も、変な人は変な人でしょ？', -5, true, @diagnosis_question_id_10),
('最も繊細な良心を持っている、周囲から理解されない孤独な人', 3, true, @diagnosis_question_id_10);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('無能な部下や上司', -5, true, @diagnosis_question_id_11),
('分かったような迎合で、多数派におもねる人', 2, true, @diagnosis_question_id_11),
('常識人', 2, true, @diagnosis_question_id_11),
('面倒くさい人', -2, true, @diagnosis_question_id_11),
('非常識な人', -1, true, @diagnosis_question_id_11);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('恐竜とか、虎のような凶暴な動物', -1, true, @diagnosis_question_id_12),
('アニメなどに出てくる鬼や、怪獣', -1, true, @diagnosis_question_id_12),
('そこらへんで散歩している、善良そうな人々', 5, true, @diagnosis_question_id_12),
('ある分野で、圧倒的な実績を叩き出した優秀な人', 0, true, @diagnosis_question_id_12),
('幽霊や妖怪', -1, true, @diagnosis_question_id_12);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('そもそも初めて聞いた言葉なんですけど', -10, true, @diagnosis_question_id_13),
('なんでネガティブな言葉ばっかり並んでいるの？', -5, true, @diagnosis_question_id_13),
('文学的な言葉だと思う。美しく高等な言葉だと思う。', 5, true, @diagnosis_question_id_13),
('え、何自殺するの？(笑)', -1, true, @diagnosis_question_id_13),
('表現が一般的ではないため、あまり積極的に使用するべき言葉ではないと思う。', 0, true, @diagnosis_question_id_13);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('あなたが不快に感じるものはなんですか？', 2, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_5);
SET @diagnosis_question_id_14 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('騒音や、乱暴な生活音', 2, true, @diagnosis_question_id_14),
('野卑な笑い方', 0, true, @diagnosis_question_id_14),
('病気', 0, true, @diagnosis_question_id_14),
('自分勝手な人間', 0, true, @diagnosis_question_id_14),
('うるさい場所。または人混み', 2, true, @diagnosis_question_id_14);

INSERT INTO diagnoses_questions (title, weighting, type, is_valid, diagnosis_id, diagnosis_header_id) VALUES
('人生でどうしても成し遂げたいことがありますが、それは自身の生活を犠牲にしなければ叶わないものでした。どうしますか？', 15, 'radio', true, @diagnosis_id_1, @diagnosis_header_id_5);
SET @diagnosis_question_id_15 = LAST_INSERT_ID();

INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('ワークライフバランスが第一なので、諦める', -5, true, @diagnosis_question_id_15),
('自分の生活をめちゃくちゃにしても、成し遂げるために努力を続ける。', 5, true, @diagnosis_question_id_15),
('迷わず生活を犠牲にして、遂行を目指す。', 10, true, @diagnosis_question_id_15),
('そのようなことは、そもそもしない。', -5, true, @diagnosis_question_id_15),
('生活を犠牲にしてしまったら元も子もないと思うから、しない。', -1, true, @diagnosis_question_id_15);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('大切な人に看取ってもらいながら、長寿を全うすること', -5, true, @diagnosis_question_id_16),
('狂死', 10, true, @diagnosis_question_id_16),
('自殺', 5, true, @diagnosis_question_id_16),
('病死', 0, true, @diagnosis_question_id_16),
('苦しみが一瞬で、すっと死ぬこと', 1, true, @diagnosis_question_id_16);
...
('周囲の無理解', -2, true, @diagnosis_question_id_17),
('「ことり」と崩れそうな生活の音', 5, true, @diagnosis_question_id_17),
('自身の才能の不足', 0, true, @diagnosis_question_id_17),
('周囲の物音', 0, true, @diagnosis_question_id_17);
...
INSERT INTO diagnoses_questions_choices (title, point, is_valid, diagnosis_question_id) VALUES
('あまり良い印象はない。', -2, true, @diagnosis_question_id_18),
